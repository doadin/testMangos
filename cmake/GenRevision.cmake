...
if(
  ...
  OR NOT EXISTS "${CMAKE_CURRENT_BINARY_DIR}/src/shared_${MANGOS_EXPANSION}/revision_data.h"
)
  configure_file(
    "${CMAKE_SOURCE_DIR}/src/shared_${MANGOS_EXPANSION}/revision_data.h.in"
    "${CMAKE_CURRENT_BINARY_DIR}/src/shared_${MANGOS_EXPANSION}/revision_data.h"
    @ONLY
  )
